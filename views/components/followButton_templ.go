...
func text(isFollowing bool) string {
	if isFollowing {
		return "UnFollow"
	} else {
		return "Follow"
...
func FollowButton(creatorId int, isFollowing bool) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var3, templ_7745c5c3_Err = templ.JoinStringErrs(text(isFollowing))
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/followButton.templ`, Line: 15, Col: 21}
		}
